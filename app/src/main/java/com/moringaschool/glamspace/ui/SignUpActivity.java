...
public class SignUpActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    @BindView(R.id.signbtn1)
    Button mCreateUserButton;
    @BindView(R.id.email1text) EditText mEmailEditText;
    @BindView(R.id.passwordtext) EditText mPasswordEditText;
    @BindView(R.id.password2text) EditText mConfirmPasswordEditText;
